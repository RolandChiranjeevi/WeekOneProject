...
//1. Skapa en class Fruit som beskriver olika frukter 2. Attributet som definieras i konstruktorn heter color och är fruktens färg 3. Skapa tre olika Fruit ifrän main-metod i en annan klass Fruitsalaca 4. Utöka Fruit sä att det kan skriva ut färgen pả frukten 5. Anropa denna metod för de tre frukterna i FruitSalad
